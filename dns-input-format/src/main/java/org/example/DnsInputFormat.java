...
public class DnsInputFormat extends FileInputFormat<LongWritable, ObjectWritable> {
	static final String READER_CLASS_PROPERTY = "net.ripe.hadoop.pcap.io.reader.class";

	public static final Log LOG = LogFactory.getLog(DnsInputFormat.class);
	...
	public static PcapReader initPcapReader(DataInputStream stream, Configuration conf) {
		try {
			Class<? extends PcapReader> pcapReaderClass = conf.getClass(READER_CLASS_PROPERTY, DnsPcapReader.class, PcapReader.class);
